...
def get_payoffs_risk(num_draws_emax, disturbances_relevant, period, k, payoffs_systematic,
    ...
    simulated, payoffs_ex_post, payoffs_future = simulate_emax(num_periods,
        num_draws_emax, period, k, disturbances_relevant_emax, payoffs_systematic, edu_max,
