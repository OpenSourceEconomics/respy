...
def simulate(robupy_obj):
    ...
    disturbances_int = create_disturbances(num_agents, seed_simulation,
    ...
    data_frame = _wrapper_simulate_sample(robupy_obj, disturbances_int)
...
def _wrapper_simulate_sample(robupy_obj, disturbances_int):
    ...
    if is_python:
        ...
        data_frame = f2py_library.wrapper_simulate_sample(num_agents,
            ...
            periods_payoffs_systematic, disturbances_int, edu_max,
