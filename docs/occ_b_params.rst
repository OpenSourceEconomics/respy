...
:math:`e_{2,3}`               return to experience, same sector, quadratic, (divided by 100)
...
:math:`e_{2,4}`               gain from having worked in the occupation at least once before
:math:`e_{2,7}`               gain from remaining in the same occupation as in previous period
