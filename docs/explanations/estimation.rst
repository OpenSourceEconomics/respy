...
Survey 1979 (NLSY79). The goal is to back out information on utility functions,
...
Given the present data structure numerous estimation procedures exist (Davidson
...
likelihood estimator in a simplified dynamic discrete choice model of schooling.
Different to Keane and Wolpin (1994, :cite:`Keane.1994`; 1997,
