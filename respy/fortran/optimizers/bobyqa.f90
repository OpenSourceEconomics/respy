...
!C
CALL BOBYQB (FUNC,N,NPT,X,XL,XU,RHOBEG,RHOEND,IPRINT,MAXFUN,W(IXB), &
...
!******************************************************************************
!******************************************************************************
SUBROUTINE BOBYQB (FUNC,N,NPT,X,XL,XU,RHOBEG,RHOEND,IPRINT, &
...
!C
CALL PRELIM (FUNC,N,NPT,X,XL,XU,RHOBEG,IPRINT,MAXFUN,XBASE,XPT, &
...
190 NFSAV=NF
KBASE=KOPT
CALL RESCUE (FUNC,N,NPT,XL,XU,IPRINT,MAXFUN,XBASE,XPT,FVAL, &
...
!*******************************************************************************
!*******************************************************************************
SUBROUTINE PRELIM (FUNC,N,NPT,X,XL,XU,RHOBEG,IPRINT,MAXFUN,XBASE, &
...
!******************************************************************************
!******************************************************************************
SUBROUTINE RESCUE (FUNC,N,NPT,XL,XU,IPRINT,MAXFUN,XBASE,XPT, &
