...
def scripts_modify(identifiers, action, init_file, values=None, bounds=None):
    ...
    for identifier in identifiers:
        ...
        elif identifier in list(range(2, 14)):
            j = identifier - 2
        ...
        elif identifier in list(range(14, 26)):
            j = identifier - 14
