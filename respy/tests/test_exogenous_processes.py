...
def test_weight_continuation_values_for_one_exogenous_process(model_with_one_exog_proc):
    ...
    state_space.get_attribute("expected_value_functions")[(0,)][:] = 1
    state_space.get_attribute("expected_value_functions")[(1,)][:] = 2
...
def test_weight_continuation_values_for_two_exog_processes(model_with_two_exog_proc):
    ...
    state_space.get_attribute("expected_value_functions")[(0, 0)][:] = 1
    state_space.get_attribute("expected_value_functions")[(0, 1)][:] = 2
    state_space.get_attribute("expected_value_functions")[(1, 0)][:] = 3
    state_space.get_attribute("expected_value_functions")[(1, 1)][:] = 4
