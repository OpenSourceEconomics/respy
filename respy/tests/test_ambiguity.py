...
class TestClass(object):
    ...
    # This section reproduces the tests from test_versions but runs them with ambiguity.
    ...
    @pytest.mark.skipif(not IS_FORTRAN, reason='No FORTRAN available')
    def test_versions_3(self, flag_ambiguity=True):
        link_versions().test_3(flag_ambiguity)

    @pytest.mark.skipif(not IS_FORTRAN, reason='No FORTRAN available')
    def test_versions_4(self, flag_ambiguity=True):
        link_versions().test_4(flag_ambiguity)

    # This section reproduces the tests from test_f2py but runs them with ambiguity.
    @pytest.mark.skipif(not IS_F2PY, reason='No F2PY available')
    ...
    # This section reproduces the tests from test_integration but runs them with ambiguity.
    ...
    def test_integration_7(self, flag_ambiguity=True):
        link_integration().test_7(flag_ambiguity)

    def test_integration_15(self, flag_ambiguity=True):
        link_integration().test_15(flag_ambiguity)