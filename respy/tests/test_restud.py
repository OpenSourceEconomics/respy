...
class TestClass(object):
    ...
    def test_1(self):
        ...
        # Solve model using RESPY package, where we need to ensure that all individual spend the
        # period before entering the model in school as well.
        edu_start = np.tile(np.nan, (num_agents_sim, 2))
        edu_start[:, 0], edu_start[:, 1] = 10, 3
