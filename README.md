...
Instructions to reproduce the original Monte Carlo in Keane & Wolpin (1994) are available [here](https://github.com/robustToolbox/package/blob/master/development/keane/README.md).
