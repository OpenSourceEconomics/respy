...
Instructions to reproduce the original Monte Carlo results from Keane & Wolpin (1994) are available [here](https://github.com/robustToolbox/package/tree/master/development/keane). 
