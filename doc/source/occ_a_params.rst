...
:math:`e_{1,4}`                gain from having worked in the occupation at least once before
:math:`e_{1,7}`                gain from remaining in the same occupation as in previous period
