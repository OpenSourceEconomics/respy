...
def tests_regression_2():
    """ Compare the solution of simple model against hard-coded results.
    """
    # Solve specified economy
    robupy_obj = read('material/second.robupy.ini')
    robupy_obj = solve(robupy_obj)
...
def tests_regression_3():
    """ Test the solution of model with ambiguity.
    """
    # Solve specified economy
    robupy_obj = read('material/third.robupy.ini')
    robupy_obj = solve(robupy_obj)
...
def tests_regression_4():
    """ Test the solution of model with ambiguity.
    """
    # Solve specified economy
    robupy_obj = read('material/fourth.robupy.ini')
    robupy_obj = solve(robupy_obj)
